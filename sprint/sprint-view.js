...
export default function PMSprintView({containerState, itemState, appPrefs, onListLimitChange,
    ...
    let columns = [];
    if (itemState.prefLabels != null && itemState.prefLabels.PM_SPRINT_PAGE != null) {
    	columns = itemState.prefLabels.PM_SPRINT_PAGE;
    }
    let group = "TABLE1";
    
    let header = "";
	if (itemState.prefTexts.PM_SPRINT_PAGE != null && itemState.prefTexts.PM_SPRINT_PAGE.PM_SPRINT_PAGE_HEADER != null) {
		header = itemState.prefTexts.PM_SPRINT_PAGE.PM_SPRINT_PAGE_HEADER.value;
	}
