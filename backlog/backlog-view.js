...
export default function PMBacklogView({itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy, onOption, 
	closeModal, inputChange, goBack, session}) {

    let columns = [];
    if (itemState.prefLabels != null && itemState.prefLabels.PM_BACKLOG_PAGE != null) {
    	columns = itemState.prefLabels.PM_BACKLOG_PAGE;
    }
    let group = "TABLE1";
	...
	if (itemState.prefTexts.PM_BACKLOG_PAGE != null && itemState.prefTexts.PM_BACKLOG_PAGE.PM_BACKLOG_PAGE_HEADER != null) {
		header = itemState.prefTexts.PM_BACKLOG_PAGE.PM_BACKLOG_PAGE_HEADER.value;
	}
